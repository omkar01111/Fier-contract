                    ...
                    {formState.submitted ? (
                      ...
                      >
                        ...
                        <p className="text-grayaccent">
                          Your message has been sent successfully. One of our
                      ...
                      >
                        <div className="grid md:grid-cols-2 gap-4">
                          ...
                          <div className="space-y-2">
                            ...
                            >
                              Email Address{" "}
                              <span className="text-firered">*</span>
                            </label>
                            <Input
                              id="email"
                              name="email"
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          ...
                          <div className="space-y-2">
                            ...
                            >
                              ...
                              <SelectContent>
                                <SelectItem value="sprinklers">
                                  Fire Sprinkler Systems
                                </SelectItem>
                                <SelectItem value="extinguishers">
                                  Fire Extinguishers
                                </SelectItem>
                                <SelectItem value="alarms">
                                  Fire Alarm Systems
                                </SelectItem>
                  ...
                  <StaggeredChildren className="space-y-6">
                    ...
                    <div className="flex items-start gap-4 group">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-grayaccent">
                          For emergencies: (555) 987-6543
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 group">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-grayaccent">
                          For support: support@fireguardsolutions.com
                        </p>
                      </div>
                    </div>
            ...
            <div className="mt-12 ">
              ...
              <div className="h-[300px] bg-muted rounded-lg overflow-hidden relative hover:shadow-lg transition-shadow duration-300">
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3768.491349640012!2d72.85794187466752!3d19.17373004889821!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b707bfffffff%3A0x6ac9c4fc7911bf6b!2sOberoi%20Mall!5e0!3m2!1sen!2sin!4v1744551938865!5m2!1sen!2sin"
